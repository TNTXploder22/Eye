  ...
  preload() {
    ...
    const assets = [
      ...
      },
      {
        type: "spritesheet",
        key: "eyeswing",
        path: "client/assets/eyeswing.png",
        frameWidth: 88,
        frameHeight: 105,
      },
    ];
